...
function readyset() {
  ...
  $('.quote_select').change(function() {
    quotes($(this).parents('form'), $(this).val())
  })
  ...
  if(!isTouch) {
    ...
    var pinner = '<a href="#" class="pinner '+pinnerState+'" onclick="javascript:$(\'#postclone\').pin();return false;" title="'+_l.pinUnpin+'"><svg class="icon b-icon"><use class="use-pin" xlink:href="#i-pin"></use><use class="use-unpin" xlink:href="#i-unpin"></use></svg></a>';
  }
  else {
    var pinner = '';
  }
