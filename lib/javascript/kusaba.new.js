...
var Ajax = {
  ...
  actuallySubmitPost: function actuallySubmitPost(form, sage) {
    var _this12 = this;

    var hCaptchaResponse = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
function readyset() {
  ...
  .on('click', '.file-menu-toggle', function (ev) {
    ...
    var fileid = $fsz.parents('figure').data('fileid'),
  ...
  getPostbox: function getPostbox(boardID) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      .then(function (data) {
        ...
        c.innerHTML = pb[1];
        var hcaptchaScript = void 0;
        if (typeof hcaptcha === 'undefined' && (hcaptchaScript = pb[1].match(/<script src="(.+?js\.hcaptcha\.com.+?)"/))) {
          head.js(hcaptchaScript[1], function () {
            return console.log('hcaptcha loaded');
          });
        }
