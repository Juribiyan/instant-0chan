...
<table class="postform">
	...
	<tr>
		...
		<td><nobr>
			...
			<div class="captchawrap" style="opacity: 0"><img class="captchaimage content-background" onclick="javascript:refreshCaptcha();" valign="middle" border="0" alt="Captcha image"></div>
		</nobr></td>
	</tr>
	{/if}
	<tr>
